...
public class DropTargetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        final ImageView imageView2 = (ImageView) rootView.findViewById(R.id.image_target1);
        ImageDragListener imageDragListener2 = new PermissionAwareImageDragListener();
         //imageDragListener = new PermissionAwareImageDragListener();

        imageView2.setOnDragListener(imageDragListener2);
      ...
      if (savedInstanceState != null) {
        ...
        final ImageView imageView3 = (ImageView) rootView.findViewById(R.id.image_target2);
        ImageDragListener imageDragListener3 = new PermissionAwareImageDragListener();
        //imageDragListener = new PermissionAwareImageDragListener();

        imageView3.setOnDragListener(imageDragListener3);
        ...
        final ImageView imageView4 = (ImageView) rootView.findViewById(R.id.image_target3);
        ImageDragListener imageDragListener4 = new PermissionAwareImageDragListener();
        //imageDragListener = new PermissionAwareImageDragListener();

        imageView4.setOnDragListener(imageDragListener4);
