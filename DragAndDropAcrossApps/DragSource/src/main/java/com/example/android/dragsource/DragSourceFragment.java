...
public class DragSourceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
       ...
       Uri  imageUri = getFileUri(R.drawable.stock2, "stock2.png");
     ImageView imageView = (ImageView) view.findViewById(R.id.imageView2);
        setUpDraggableImage(imageView, imageUri);
        imageView.setImageURI(imageUri);

        imageUri = getFileUri(R.drawable.images23, "images23.jpg");
        ...
        imageUri = getFileUri(R.drawable.image61, "image61.jpg");
        imageView = (ImageView) view.findViewById(R.id.imageView6);
        setUpDraggableImage(imageView, imageUri);
        imageView.setImageURI(imageUri);

        imageUri = getFileUri(R.drawable.weather, "weather.png");
        ...
        imageUri = getFileUri(R.drawable.dell4, "dell4.png");
        imageView = (ImageView) view.findViewById(R.id.imageView4);
        setUpDraggableImage(imageView, imageUri);
        imageView.setImageURI(imageUri);

        imageUri = getFileUri(R.drawable.imagess99, "imagess99.png");
